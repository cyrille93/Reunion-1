...
<div class="row mt">
          <div class="col-lg-8 align-items-center">
            <h4><i class="fa fa-angle-right"></i>EDITER REUNION</h4>
              ...
              <div class=" form" method="POST">
                ...
                <div class="form-group ">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="cname" placeholder="" name="telephone_fondateur" minlength="2" type="text" required />
                    </div>
                  </div>
                <div class="form-group ">
                    <label for="cname" class="control-label col-lg-2">Adresse (Obligatoire)</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="cname" placeholder="" name="adresse_fondateur" minlength="2" type="text" required />
                    </div>
                  </div>
                  <div class="form-group">
